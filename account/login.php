    ...
    <div class="row">
      <div class="offset-lg-2 col-lg-8 col-md-12 col-12">
        ...
        <div id="CustomerLoginForm" class="login">
          <form method="post" action="https://phuler.myshopify.com/account/login" id="customer_login" accept-charset="UTF-8" data-login-with-shop-sign-in="true"><input type="hidden" name="form_type" value="customer_login" /><input type="hidden" name="utf8" value="✓" />
            ...
            <div class="login-form">
              ...
              <div class="button-box">
                <div class="login-toggle-btn">
                  <button type="submit" class="section-button">Sign In</button>
...
<style>
  ...
  #section-footer .effect-snow {
    background-image: url(login.php\/\/via.placeholder.com\/500x500);
