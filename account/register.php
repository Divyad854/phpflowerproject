        ...
        <div class="login">
          <div class="login-form-container">
            ...
            <div class="login-form">
              <form method="post" action="https://phuler.myshopify.com/account" id="create_customer" accept-charset="UTF-8" data-login-with-shop-sign-up="true"><input type="hidden" name="form_type" value="create_customer" /><input type="hidden" name="utf8" value="✓" />
              ...
              <div class="button-box">
                <div class="login-toggle-btn">
                  <button type="submit" class="section-button">Create</button>
                </div>
              </div>
              </form>
            </div>
