...
<input type="text" name="first_name" id="FirstName" class="input-full" placeholder="First Name" pattern="^[a-z]*$" autocapitalize="words" title="Must contain character" autofocus required>

<label for="MiddleName" class="hidden-label">Middle name</label>
<input type="text" name="middle_name" id="MiddleName" class="input-full" placeholder="Middle Name" pattern="^[a-z]*$" title="Must contain character" autocapitalize="words" required>

<label for="LastName" class="hidden-label">Last Name</label>
<input type="text" name="last_name" id="LastName" class="input-full" placeholder="Last Name" pattern="^[a-z]*$" title="Must contain character" autocapitalize="words" required>
...
<input type="text" name="city" value="Surat" required>
...
<input type="text" name="user_name" id="UserName" class="input-full" placeholder="User Name" pattern="^[a-z]*$" title="Must contain character" autocapitalize="words" autofocus required>
